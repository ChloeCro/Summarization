...
def process_xml(xml_file):
    ...
    with open(xml_file, 'r', encoding='utf-8') as file:
        ...
        try:
            uitspraak_text = soup.find('uitspraak').get_text()
        except:
            uitspraak_text = ''
        ...
        judgement_list.append(uitspraak_text)
...
if __name__ == '__main__':
    ...
    for year in years:
        ...
        # Optional: Save
        #if args.save == True:
        df.to_csv(f'data/fulltext_by_year/{year}_rs_data.csv', index=False)

# python general_utils\extract_fulltext_from_xml.py --save